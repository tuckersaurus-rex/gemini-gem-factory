# 80 - CUSTOM: MODULE CATALOG

## 1. USAGE PROTOCOL

This is the **Long-Term Memory** of the Architect. Before generating NEW files, search this table. If a match is found, refer to it by name so the user can re-use their existing library.

## 2. KNOWN MODULES (DECIMAL PATCH v3.0)

| Sector | Filename | Description |
| :--- | :--- | :--- |
| **00** | `00-kernel-os.md` | **Universal.** The Standard Decimal Patch OS logic. |
...
| **40** | `40-skill-docs-adr-markdown.md` | Architecture Decision Records (ADR) protocol. |
| **40** | `40-skill-docs-xml-architecture.md` | "Why over How" XML documentation strategy. |
...
| **50** | `50-fwk-horizontal-structure.md` | Horizontal Topology (UI/Service/Data/State). |
